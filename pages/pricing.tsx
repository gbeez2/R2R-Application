...
const Pricing = () => {
  ...
  const handleCheckout = async (planName: string, price: string) => {
    ...
    try {
      ...
      alert('Error initiating checkout: ' + errorMessage);
    }
  };
  ...
  const plans = [
    {
      ...
      period: 'USD/month',
      description:
        'Best for everyday analysis, reports, and smaller data tasks.',
      features: [
    ...
    },
    {
      ...
      period: 'USD/month',
      description:
        'Great for machine learning, large files & qualitative analysis',
      features: [
    ...
    },
    {
      ...
      period: 'USD/month',
      description:
        'Great for big data, machine learning, and qualitative analysis',
      features: [
