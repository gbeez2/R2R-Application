...
const LandingPage = () => {
  ...
  useEffect(() => {
    ...
    if (!isDeleting && rotatingText.length < currentRotatingText.length) {
      // Typing
      const timeout = setTimeout(() => {
        setRotatingText(currentRotatingText.substring(0, rotatingText.length + 1));
      }, 100);
      return () => clearTimeout(timeout);
      ...
      return () => clearTimeout(timeout);
    } else if (!isDeleting && rotatingText.length === currentRotatingText.length) {
      ...
      <main className="bg-circuit-silver/10 min-h-screen">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="text-left mb-4">
            <h1 className="text-6xl lg:text-7xl font-bold text-insulation-black" style={{ fontFamily: 'Roboto, sans-serif' }}>
          ...
          <div className="text-left mb-6">
            <p className="text-3xl text-circuit-silver max-w-5xl font-light tracking-wide leading-relaxed">
              AI-powered VBA macro generation. Describe your simulation needs and get production-ready code instantly.
            </p>
          </div>
          ...
          <div className="bg-pure-white rounded-2xl p-8 shadow-lg border border-circuit-silver/20">
            ...
            <div className="flex items-center gap-3 mb-6">
              <div className="relative">
                ...
                >
                  ...
                  <ChevronDown className={`w-4 h-4 transition-transform ml-2 ${isDropdownOpen ? 'rotate-180' : ''}`} />
                </button>
              ...
              <div className="relative software-dropdown">
                ...
                >
                  ...
                  <ChevronDown className={`w-4 h-4 transition-transform ml-2 ${isSoftwareDropdownOpen ? 'rotate-180' : ''}`} />
                </button>
            ...
            <div className="mb-6 relative">
              <textarea
                placeholder={typewriterText || "Create a CST macro to automate antenna design and simulation..."}
              ...
              >
                {isLoading ? (
                  <div className="w-5 h-5">
                    ...
                    <svg width="20" height="20" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="animate-spin">
                      {/* Yellow horizontal fulcrum line */}
                      <rect x="2" y="14" width="28" height="6" rx="3" fill="#FFD700" />
                      {/* Blue square on the left */}
                      <rect x="4" y="6" width="10" height="10" rx="2" fill="#0066CC" />
            ...
            <div className="mt-4 flex justify-start gap-3">
              ...
              <Button
                color="transparent"
                shape="outline_wide"
                onClick={() => {/* Handle explore macro templates */ }}
                className="border-circuit-silver/30 text-insulation-black hover:border-electric-blue hover:bg-electric-blue/5 flex items-center px-5 py-3"
              >
          ...
          <div className="mt-16 mb-8">
            <div className="text-center mb-2">
              <h3 className="text-3xl font-semibold text-insulation-black mb-0">Trusted by Leading Electrical Engineers</h3>
              <p className="text-sm text-insulation-black/70">Powering electromagnetic design at top companies worldwide</p>
            </div>
            ...
            <div className="relative overflow-hidden bg-gradient-to-r from-pure-white to-circuit-silver/5 rounded-xl py-6">
              <div className="flex animate-scroll">
                ...
                <div className="flex items-center space-x-20 px-8">
                  <img src="/images/trane.png" alt="Trane" className="h-16 w-auto object-contain" />
                  <img src="/images/google.webp" alt="Google" className="h-16 w-auto object-contain" />
                  <img src="/images/apple.png" alt="Apple" className="h-16 w-auto object-contain" />
                  <img src="/images/meta.png" alt="Meta" className="h-20 w-auto object-contain" />
                </div>
          ...
          <div className="mt-16 text-center">
            ...
            <p className="text-xl text-circuit-silver mb-8 max-w-2xl mx-auto">
              Join electrical engineers worldwide who are accelerating their CST simulations with AI-powered macro generation.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                color="transparent"
                shape="outline_wide"
                onClick={() => window.open('https://r2r-docs.sciphi.ai', '_blank')}
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-circuit-silver">
                AI-powered CST macro generation for electrical engineering professionals.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-circuit-silver">
                <li><a href="#" className="hover:text-pure-white">Features</a></li>
                <li><a href="#" className="hover:text-pure-white">Pricing</a></li>
                <li><a href="#" className="hover:text-pure-white">Documentation</a></li>
                <li><a href="#" className="hover:text-pure-white">API Reference</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-circuit-silver">
                <li><a href="https://github.com/SciPhi-AI/R2R" target="_blank" className="hover:text-pure-white">GitHub</a></li>
                <li><a href="https://discord.gg/p6KqD2kjtB" target="_blank" className="hover:text-pure-white">Discord</a></li>
                <li><a href="https://twitter.com/ocolegro" target="_blank" className="hover:text-pure-white">Twitter</a></li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-circuit-silver">
                <li><a href="#" className="hover:text-pure-white">About</a></li>
                <li><a href="#" className="hover:text-pure-white">Contact</a></li>
                <li><a href="#" className="hover:text-pure-white">Privacy</a></li>
                <li><a href="#" className="hover:text-pure-white">Terms</a></li>
              </ul>
            </div>
          </div>
