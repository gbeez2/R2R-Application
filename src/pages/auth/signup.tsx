          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-8">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-pure-white">MacroPilot</span>
              </div>
              <div className="relative products-dropdown">
                <div className="flex items-center space-x-1 cursor-pointer" onClick={() => setIsProductsDropdownOpen(!isProductsDropdownOpen)}>
                ...
                {isProductsDropdownOpen && (
                  <div className="absolute top-full left-0 mt-2 bg-pure-white border border-circuit-silver/30 rounded-lg shadow-lg z-50 min-w-64">
                    <div className="py-2">
                      <div className="px-4 py-2 text-sm font-medium text-insulation-black border-b border-circuit-silver/20">Current Products</div>
                      ...
                      <div className="px-4 py-2 text-sm font-medium text-insulation-black border-b border-circuit-silver/20 mt-2">Coming Soon</div>
              ...
              <div className="relative solutions-dropdown">
                <div className="flex items-center space-x-1 cursor-pointer" onClick={() => setIsSolutionsDropdownOpen(!isSolutionsDropdownOpen)}>
                ...
                {isSolutionsDropdownOpen && (
                  <div className="absolute top-full left-0 mt-2 bg-pure-white border border-circuit-silver/30 rounded-lg shadow-lg z-50 min-w-72">
                    <div className="py-2">
                      <div className="px-4 py-2 text-sm font-medium text-insulation-black border-b border-circuit-silver/20">By Industry</div>
                      <button className="w-full text-left px-4 py-3 hover:bg-circuit-silver/10 text-insulation-black transition-colors">
              ...
              <div className="relative resources-dropdown">
                <div className="flex items-center space-x-1 cursor-pointer" onClick={() => setIsResourcesDropdownOpen(!isResourcesDropdownOpen)}>
                ...
                {isResourcesDropdownOpen && (
                  <div className="absolute top-full left-0 mt-2 bg-pure-white border border-circuit-silver/30 rounded-lg shadow-lg z-50 min-w-64">
                    <div className="py-2">
                      <div className="px-4 py-2 text-sm font-medium text-insulation-black border-b border-circuit-silver/20">Documentation</div>
                      <button className="w-full text-left px-4 py-3 hover:bg-circuit-silver/10 text-insulation-black transition-colors">
            ...
            <div className="flex items-center space-x-3">
              <a href="/auth/login" className="px-4 py-2 text-pure-white hover:text-pure-white transition-colors rounded-md">Log In</a>
              <button className="px-4 py-2 text-pure-white hover:text-pure-white transition-colors rounded-md">Contact</button>
              <a href="/auth/signup" className="px-4 py-2 bg-pure-white text-insulation-black hover:bg-circuit-silver transition-colors rounded-md font-medium">Sign Up</a>
            </div>
          </div>
        </div>
      </nav>
